...
#  scrapy crawl tr_old -a title='Old' -a result='old.json'


class TamilOldMoviesSpider(BaseTRSpider):
    name = "tr_old"

    def start_requests(self):
        self.process_title()

        urls = ['https://tamilrockers.ws/index.php/forum/6-tamil-old-mid-dvdrips-hdrips-'
                'bdrips-movies/page-1?prune_day=100&sort_by=Z-A&sort_key=last_post&topicfilter=all']
        for url in urls:
